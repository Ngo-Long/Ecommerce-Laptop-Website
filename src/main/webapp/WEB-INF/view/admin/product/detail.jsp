                                            ...
                                            <div class="card" style="width: 50%;">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">
                                                        Price:
                                                        <fmt:formatNumber type="number" value="${dataProduct.price}" />
                                                        đ
                                                    </li>
                                                    <li class="list-group-item">Quantity: ${dataProduct.quantity}</li>
                                                    <li class="list-group-item">Sold: ${dataProduct.sold}</li>
                                                    <li class="list-group-item">Detail desc: ${dataProduct.detailDesc}
                                                    </li>
                                                    <li class="list-group-item">Short desc: ${dataProduct.shortDesc}
                                                    </li>
